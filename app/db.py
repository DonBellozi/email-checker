...
DEFAULT_SMTP_STATUSES = [
    ...
    ("4.1.2", "Домен получателя не найден", "Почтовый домен получателя не существует или не разрешается через DNS."),
    ...
    ("5.1.3", "Некорректный адрес получателя", "Адрес получателя записан с синтаксической ошибкой."),
